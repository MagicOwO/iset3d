...
fname = '/home/wandell/pbrt-v2-spectral/pbrtScenes/villaLights/villaLights.pbrt';
...
thisR = recipeSet(thisR,'pixel samples',  512);
...
thisR.set('outputFile',fullfile(piRootPath,'local','villalight',[n,e]));
